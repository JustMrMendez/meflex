...
import { UserAuthForm } from "@/components/ui-wrap/user-auth-form";
				...
				<div className="relative hidden h-full flex-col bg-muted p-10 dark:border-r lg:flex">
					<div className="absolute inset-0">
						<img
							src="/authentication-light.webp"
							alt="Authentication"
							className="block dark:hidden object-cover h-full w-full"
						/>
						<img
							src="/authentication-dark.webp"
							alt="Authentication"
